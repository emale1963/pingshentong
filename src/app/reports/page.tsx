          ...
          {loading ? (
            ...
            <div className="card text-center py-12">
              ...
              <div className="mt-6">
                <Link
                  href="/"
                  className="inline-flex items-center px-6 py-2.5 border border-transparent rounded-[var(--radius-base)] text-sm font-medium text-white bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary-hover)] transition-colors duration-[var(--transition-fast)]"
                  style={{ color: '#ffffff' }}
                >
                  请上传文件
                </Link>
